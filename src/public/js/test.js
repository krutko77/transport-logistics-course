...
// 2 варианта по 25-26 вопросов — в каждом по 5 вопросов из каждого
// из 5 блоков материалов курса (блок 1: id 1–10, блок 2: id 11–20,
// блок 3: id 21–27, блок 4: id 28–36, 50, блок 5: id 37–49) плюс по
// одному вопросу из блока 6 (id 51–52, ограничения по массе и оси).
// Вместе оба варианта покрывают все 52 вопроса банка без пропусков и без пересечений —
// последовательное прохождение обоих вариантов даёт полное покрытие курса.
const VARIANTS = [
  [1, 2, 3, 4, 5, 11, 12, 13, 14, 15, 21, 22, 23, 24, 25, 28, 29, 30, 31, 32, 37, 38, 46, 47, 48, 51],
  [6, 7, 8, 9, 10, 16, 17, 18, 19, 20, 26, 27, 33, 34, 35, 36, 50, 39, 40, 41, 42, 43, 44, 45, 49, 52],
];
